    ...
    <div className="legal-section-title">
      ...
      <div className="legal-text-content">
        ...
        <p className="legal-description">
          Welcome to Wellbeing Hub, your trusted online healthcare platform. Our
        ...
        <p className="legal-description">
          When using Wellbeing Hub, you agree to our Terms of Service. This
        ...
        <p className="legal-description">
          Wellbeing Hub is designed to simplify healthcare access. You can choose
      ...
      <div className="legal-footer">
        <p>© 2024-2030 Health+. All rights reserved.</p>
      </div>
    </div>
  );
}
